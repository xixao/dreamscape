...
- Keyboard: Shift+G toggles the layout grid, Cmd+' toggles the pixel grid, Cmd+Shift+arrows nudge frames by 64 px, Alt held while dragging shows distances to neighbours.
